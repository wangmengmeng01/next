...
//							    city_id : cityId,
//							    showType : "city"
//								dateStyle:($('#dateStyle').val()==null)?'':$('#dateStyle').val(),
//								qu_date:($('#quDate').val()==null)?'':$('#quDate').val(),
//								month_year:($('#monthYear').val()==null)?''$('#monthYear').val(),
//								quarter_year:($('#quarterYear').val()==null)?''$('#quarterYear').val(),
//								quarter_date:($('#quarterDate').val()==null)?''$('#quarterDate').val(),
...
//							    city_id : ($('#cityid').val()==null)?''$('#cityid').val(),
							    showType : "city"
//								province_id :"120000",
//							    region_id : "北京大区",
//							    city_id : null,
