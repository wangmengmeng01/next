 ...
 */
public class ExportCostreportOrderCostFinishDO implements Serializable {
	...
	//票件量
	@ExcelField(title = "票件量", order = 3)
	private Integer orderSum;
	//总重量
	@ExcelField(title = "重量", order = 4)
	private BigDecimal weightAll;
	//收入
	@ExcelField(title = "收入", order = 5)
	private BigDecimal income;
	//支出
	@ExcelField(title = "支出", order = 6)
	private BigDecimal expenditure;
	//利润
	@ExcelField(title = "利润", order = 7)
	private BigDecimal profit;
	//单票收入
	@ExcelField(title = "单票收入", order = 8)
	private BigDecimal incomeEach;
	//单公斤收入
	@ExcelField(title = "单公斤收入", order = 9)
	private BigDecimal kilogramEach;
	//单票收益
	@ExcelField(title = "单票收益", order = 10)
	private BigDecimal profitEach;
	//单公斤收益
	@ExcelField(title = "单公斤收益", order = 11)
