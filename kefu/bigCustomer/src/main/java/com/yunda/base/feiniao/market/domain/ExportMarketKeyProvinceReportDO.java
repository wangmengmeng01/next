...
public class ExportMarketKeyProvinceReportDO implements Serializable {
	private static final long serialVersionUID = 1L;
	
	@ExcelField(title = "基础信息", order = 1)
	private String basicalInformation;
	
	@ExcelField(title = "考核对象", order = 2)
	private String responsiblePeople;
	
	@ExcelField(title = "考核得分", order = 3)
	private Integer monthScore;
	
	@ExcelField(title = "A/B", order = 4)
	private String AB;

	@ExcelField(title = "C/D", order = 5)
	private String CD;
	
	@ExcelField(title = "日均量", order = 6)
	private String kdqsrjdl;
	
	@ExcelField(title = "月总量", order = 7)
	private String kdqsyzl;
	
	@ExcelField(title = "月总量", order = 8)
	private String ydqsyzl;
	
	@ExcelField(title = "日均量", order = 9)
	private String ydqsrjl;
	
	@ExcelField(title = "市场份额占比", order = 10)
	private String ydqsscfezb;
	
	@ExcelField(title = "月总量", order = 11)
	private String ztqsyzl;
	
	@ExcelField(title = "日均量", order = 12)
	private String ztqsrjl;

	@ExcelField(title = "市场份额占比", order = 13)
	private String ztqsscfezb;
	
	@ExcelField(title = "月总量", order = 14)
	private String ytqsyzl;
	
	@ExcelField(title = "日均量", order = 15)
	private String ytqsrjl;
	
	@ExcelField(title = "市场份额占比", order = 16)
	private String ytqsscfezb;
	
	@ExcelField(title = "月总量", order = 17)
	private String stqsyzl;
	
	@ExcelField(title = "日均量", order = 18)
	private String stqsrjl;

	@ExcelField(title = "市场份额占比", order = 19)
	private String stqsscfezb;

	@ExcelField(title = "月总量", order = 20)
	private String bsqsyzl;
	
	@ExcelField(title = "日均量", order = 21)
	private String bsqsrjl;
	
	@ExcelField(title = "市场份额占比", order = 22)
