...
/**
 * (导出)客户报表订单统计/客户支出报表(完成统计)
 * 
 * @author yunda
 * @email zhanghan813@163.com
 * @date 2018-09-13145339
 */
public class ExportCostreportCustCostFinishDO implements Serializable {
	...
	//始发省名称
	@ExcelField(title = "始发省", order = 3)
	private String startProvinceName;
	//目的省名称
	@ExcelField(title = "目的省", order = 4)
	...
	//中转费
	@ExcelField(title = "中转费", order = 7)
	private BigDecimal tsfFee;
	//派费
	@ExcelField(title = "派费", order = 8)
	private BigDecimal deliveryFee;
	//续重派费
	@ExcelField(title = "续重派费", order = 9)
	private BigDecimal deliveryAdditionalWeightFee;
	//平衡派费
	@ExcelField(title = "平衡派费", order = 10)
	private BigDecimal deliveryBalanceFee;
	//面单费
	@ExcelField(title = "面单费", order = 11)
	private BigDecimal shipmentFee;
	//扫描费73
	@ExcelField(title = "扫描费", order = 12)
	private BigDecimal scanFee;
	//人力成本
	@ExcelField(title = "人力成本", order = 13)
	private BigDecimal peopleCost;
	//物料费
	@ExcelField(title = "物料费", order = 14)
	private BigDecimal materielCost;
	//运输成本
	@ExcelField(title = "运输成本", order = 15)
	private BigDecimal tsfCost;
	//回扣
	@ExcelField(title = "回扣", order = 16)
	private BigDecimal hhCost;
	//税金
	@ExcelField(title = "税金", order = 17)
	private BigDecimal taxesCost;
	//票均包仓费
	@ExcelField(title = "票均包仓费", order = 18)
	private BigDecimal packingCharge;
	//其他费用
	@ExcelField(title = "其他费用", order = 19)
