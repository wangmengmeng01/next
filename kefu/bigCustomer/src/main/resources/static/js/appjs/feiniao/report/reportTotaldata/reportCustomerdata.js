...
//							    prefix: "2018-07-25_2018-07-25",
						...
						columns : [
							...
							{field:'priceSum',title:'金额', width : 180,align:'center'},
							{field:'dianziOrderSum',title:'总奖励金额', width : 180,align:'center'}
						]
					});
}
...
$('#exportExcelbtn').click(function(){  
	...
	var url = prefix + "/exportCustExcel"+"?start_date="+start_date+"&end_date="+end_date+"&showType="+showType+"&tmp_field="+tmp_field+"&fbbm="+fbbm+"&branch_code="+branch_code;
	window.open(url);
}); 
