var prefix = "/vipkf/system/videoDownload";
$(function() {
	load();
	...
	$('#exampleTable').bootstrapTable({
		...
		columns : [ {
			...
			formatter : function(value, row, index) {
				var f = '<a class="btn btn-success btn-sm" href="#" title="下载"  mce_href="#" onclick="downloadVideo(\'' + row.id + '\')"><i class="fa fa-key"></i></a> ';
				return f;
			}
		} ]
	});
...
function downloadVideo(id) {
	...
	$eleForm.attr("action", prefix + "/download/" + id);
