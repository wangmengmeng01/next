				...
				columns : [
                    ...
                    },
                    {
                        ...
                        formatter : function(value, row, index) {
                            if(row.status==1){
                                var e = "<a href='javascript:void(0);' style='color:blue;' onclick='stateUpdate(\""+row.userId+","+row.status+"\");'>"+' <font style="text-decoration:underline">启用</font> '+'</a>';;
                                return e;
                            }else {
                                var e = "<a href='javascript:void(0);' style='color:blue;' onclick='stateUpdate(\""+row.userId+","+row.status+"\");'>"+' <font style="text-decoration:underline">禁止</font> '+'</a>';;
                                return e;
                            }
                        }
                    },
