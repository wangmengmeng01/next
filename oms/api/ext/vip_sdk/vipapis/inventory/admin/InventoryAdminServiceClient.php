...
class InventoryAdminServiceClient{
	...
	public static function getService(){
		...
		if (! InventoryAdminServiceClient::$isRegis){
			
			InventoryAdminServiceClient::regis ();
			InventoryAdminServiceClient::$isRegis = true;
		}
		
		
		$ctx = \Osp\Context\InvocationContextFactory::getInstance ();
		$ip = InventoryAdminServiceClient::$DEFAULT_PROXY_IP;
		$port = InventoryAdminServiceClient::$DEFAULT_PROXY_PORT;	
		try{
		...
		return new \vipapis\inventory\admin\InventoryAdminServiceHelper();
	}
