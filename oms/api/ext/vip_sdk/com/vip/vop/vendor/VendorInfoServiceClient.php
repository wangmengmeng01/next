...
class VendorInfoServiceClient{
	...
	public static function getService(){
		...
		if (! VendorInfoServiceClient::$isRegis){
			
			VendorInfoServiceClient::regis ();
			VendorInfoServiceClient::$isRegis = true;
		}
		
		
		$ctx = \Osp\Context\InvocationContextFactory::getInstance ();
		$ip = VendorInfoServiceClient::$DEFAULT_PROXY_IP;
		$port = VendorInfoServiceClient::$DEFAULT_PROXY_PORT;	
		try{
		...
		return new \com\vip\vop\vendor\VendorInfoServiceHelper();
	}
