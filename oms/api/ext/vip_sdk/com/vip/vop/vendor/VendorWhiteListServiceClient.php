...
class VendorWhiteListServiceClient{
	...
	public static function getService(){
		...
		if (! VendorWhiteListServiceClient::$isRegis){
			
			VendorWhiteListServiceClient::regis ();
			VendorWhiteListServiceClient::$isRegis = true;
		}
		
		
		$ctx = \Osp\Context\InvocationContextFactory::getInstance ();
		$ip = VendorWhiteListServiceClient::$DEFAULT_PROXY_IP;
		$port = VendorWhiteListServiceClient::$DEFAULT_PROXY_PORT;	
		try{
		...
		return new \com\vip\vop\vendor\VendorWhiteListServiceHelper();
	}
