...
interface OtoProductServiceIf{
	...
	public function getSkuDetail( $v_sku_id);
	
	public function getSpuDetail( $v_spu_id);
...
class _OtoProductServiceClient extends \Osp\Base\OspStub implements \com\vip\vop\cup\api\oto\OtoProductServiceIf{
	...
	public function getSkuDetail( $v_sku_id){
		...
		$this->send_getSkuDetail( $v_sku_id);
		return $this->recv_getSkuDetail();
	}
	
	public function send_getSkuDetail( $v_sku_id){
	...
	public function getSpuDetail( $v_spu_id){
		...
		$this->send_getSpuDetail( $v_spu_id);
		return $this->recv_getSpuDetail();
	}
	
	public function send_getSpuDetail( $v_spu_id){
