...
class ScheduleSalesSyncServiceClient{
	...
	public static function getService(){
		...
		if (! ScheduleSalesSyncServiceClient::$isRegis){
			
			ScheduleSalesSyncServiceClient::regis ();
			ScheduleSalesSyncServiceClient::$isRegis = true;
		}
		
		
		$ctx = \Osp\Context\InvocationContextFactory::getInstance ();
		$ip = ScheduleSalesSyncServiceClient::$DEFAULT_PROXY_IP;
		$port = ScheduleSalesSyncServiceClient::$DEFAULT_PROXY_PORT;	
		try{
		...
		return new \com\vip\vop\sync\ScheduleSalesSyncServiceHelper();
	}
