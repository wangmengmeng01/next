...
class GetReturnOrExchangeGoodsResp {
	...
	public function getName(){
		...
		return 'GetReturnOrExchangeGoodsResp';
	}
			...
			if ("allowedGoodsList" == $schemeField){
				...
				while(true){
					...
					try{
						...
						$elem1 = new \com\vip\order\common\pojo\order\vo\ReturnOrExchangeGoodsVO();
						$elem1->read($input);
						
						$this->allowedGoodsList[$_size1++] = $elem1;
					}
					catch(\Exception $e){
			...
			if ("unallowedGoodsList" == $schemeField){
				...
				while(true){
					...
					try{
						...
						$this->unallowedGoodsList[$_size2++] = $elem2;
					}
					catch(\Exception $e){
