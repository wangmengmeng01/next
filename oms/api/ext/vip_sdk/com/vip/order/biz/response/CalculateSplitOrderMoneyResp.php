...
class CalculateSplitOrderMoneyResp {
	...
	public function getName(){
		...
		return 'CalculateSplitOrderMoneyResp';
	}
			...
			if ("splitOrderList" == $schemeField){
				...
				while(true){
					...
					try{
						...
						$elem0 = new \com\vip\order\common\pojo\order\vo\SplitOrderVO();
						$elem0->read($input);
						
						$this->splitOrderList[$_size0++] = $elem0;
					}
					catch(\Exception $e){
