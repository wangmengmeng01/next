...
class ConfirmOrderGroupBuyResp {
	...
	public function getName(){
		...
		return 'ConfirmOrderGroupBuyResp';
	}
			...
			if ("statusList" == $schemeField){
				...
				while(true){
					...
					try{
						...
						$elem0 = new \com\vip\order\common\pojo\order\vo\ConfirmOrderGroupBuyVO();
						$elem0->read($input);
						
						$this->statusList[$_size0++] = $elem0;
					}
					catch(\Exception $e){
