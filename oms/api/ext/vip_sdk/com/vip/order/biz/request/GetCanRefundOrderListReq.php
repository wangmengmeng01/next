...
class GetCanRefundOrderListReq {
	...
	public function getName(){
		...
		return 'GetCanRefundOrderListReq';
	}
	...
	public function read($input){
		...
		while(true){
			...
			if ("requirement" == $schemeField){
				
				$needSkip = false;
				
				$this->requirement = new \com\vip\order\biz\request\ResultRequirementMap();
				$this->requirement->read($input);
	...
	public function write($output){
		...
		if($this->requirement !== null) {
			...
			$xfer += $output->writeFieldBegin('requirement');
			
			if (!is_object($this->requirement)) {
				
				throw new \Osp\Exception\OspException('Bad type in structure.', \Osp\Exception\OspException::INVALID_DATA);
			}
			
			$xfer += $this->requirement->write($output);
