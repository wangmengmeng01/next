...
class OrdersBizServiceClient{
	...
	public static function getService(){
		...
		if (! OrdersBizServiceClient::$isRegis){
			
			OrdersBizServiceClient::regis ();
			OrdersBizServiceClient::$isRegis = true;
		}
		
		
		$ctx = \Osp\Context\InvocationContextFactory::getInstance ();
		$ip = OrdersBizServiceClient::$DEFAULT_PROXY_IP;
		$port = OrdersBizServiceClient::$DEFAULT_PROXY_PORT;	
		try{
		...
		return new \com\vip\order\biz\service\OrdersBizServiceHelper();
	}
