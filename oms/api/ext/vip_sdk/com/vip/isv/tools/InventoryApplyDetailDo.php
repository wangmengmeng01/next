...
class InventoryApplyDetailDo {
	...
	public function __construct($vals=null){
		...
		if (is_array($vals)){
			...
			if (isset($vals['isIncrement'])){
				
				$this->isIncrement = $vals['isIncrement'];
			}
	...
	public function read($input){
		...
		while(true){
			...
			if ("isIncrement" == $schemeField){
				
				$needSkip = false;
				$input->readI32($this->isIncrement); 
	...
	public function write($output){
		...
		if($this->isIncrement !== null) {
			
			$xfer += $output->writeFieldBegin('isIncrement');
			$xfer += $output->writeI32($this->isIncrement);
