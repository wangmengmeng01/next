...
class UpdateStockToWhiServiceClient{
	...
	public static function getService(){
		...
		if (! UpdateStockToWhiServiceClient::$isRegis){
			
			UpdateStockToWhiServiceClient::regis ();
			UpdateStockToWhiServiceClient::$isRegis = true;
		}
		
		
		$ctx = \Osp\Context\InvocationContextFactory::getInstance ();
		$ip = UpdateStockToWhiServiceClient::$DEFAULT_PROXY_IP;
		$port = UpdateStockToWhiServiceClient::$DEFAULT_PROXY_PORT;	
		try{
		...
		return new \com\vip\isv\tools\UpdateStockToWhiServiceHelper();
	}
