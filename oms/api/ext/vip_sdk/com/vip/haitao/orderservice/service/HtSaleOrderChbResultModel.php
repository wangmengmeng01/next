...
class HtSaleOrderChbResultModel {
	...
	public $eBusinessCompanyCode = null;
	public $eBusinessCompanyName = null;
	public $payEnterpriseCode = null;
	public $payEnterpriseName = null;
	public $sender = null;
	public $salerCountry = null;
	public $logisCompanyCode = null;
	public $logisCompanyName = null;
	...
	public function __construct($vals=null){
		...
		if (!isset(self::$_TSPEC)){
			...
			75 => array(
			'var' => 'eBusinessCompanyCode'
			),
			76 => array(
			'var' => 'eBusinessCompanyName'
			),
			77 => array(
			'var' => 'payEnterpriseCode'
			),
			78 => array(
			'var' => 'payEnterpriseName'
			),
			79 => array(
			'var' => 'sender'
			),
			...
			81 => array(
			'var' => 'logisCompanyCode'
			),
			82 => array(
			'var' => 'logisCompanyName'
			),
		...
		if (is_array($vals)){
			...
			if (isset($vals['ebpCode'])){
				
				$this->ebpCode = $vals['ebpCode'];
			}
			
			
			if (isset($vals['ebpName'])){
				
				$this->ebpName = $vals['ebpName'];
			}
			
			
			if (isset($vals['ebcCode'])){
				
				$this->ebcCode = $vals['ebcCode'];
			}
			
			
			if (isset($vals['ebcName'])){
				
				$this->ebcName = $vals['ebcName'];
			}
			...
			if (isset($vals['currCode'])){
				
				$this->currCode = $vals['currCode'];
			}
			
			
			if (isset($vals['eBusinessCompanyCode'])){
				
				$this->eBusinessCompanyCode = $vals['eBusinessCompanyCode'];
			}
			
			
			if (isset($vals['eBusinessCompanyName'])){
				
				$this->eBusinessCompanyName = $vals['eBusinessCompanyName'];
			}
			
			
			if (isset($vals['payEnterpriseCode'])){
				
				$this->payEnterpriseCode = $vals['payEnterpriseCode'];
			}
			
			
			if (isset($vals['payEnterpriseName'])){
				
				$this->payEnterpriseName = $vals['payEnterpriseName'];
			}
			...
			if (isset($vals['salerCountry'])){
				
				$this->salerCountry = $vals['salerCountry'];
			}
			
			
			if (isset($vals['logisCompanyCode'])){
				
				$this->logisCompanyCode = $vals['logisCompanyCode'];
			}
			
			
			if (isset($vals['logisCompanyName'])){
				
				$this->logisCompanyName = $vals['logisCompanyName'];
			}
	...
	public function read($input){
		...
		while(true){
			...
			if ("ebpCode" == $schemeField){
				
				$needSkip = false;
				$input->readString($this->ebpCode);
			...
			if ("ebpName" == $schemeField){
				
				$needSkip = false;
				$input->readString($this->ebpName);
			...
			if ("ebcCode" == $schemeField){
				
				$needSkip = false;
				$input->readString($this->ebcCode);
			...
			if ("ebcName" == $schemeField){
				
				$needSkip = false;
				$input->readString($this->ebcName);
			...
			if ("currCode" == $schemeField){
				
				$needSkip = false;
				$input->readString($this->currCode);
			...
			if ("eBusinessCompanyCode" == $schemeField){
				
				$needSkip = false;
				$input->readString($this->eBusinessCompanyCode);
			...
			if ("eBusinessCompanyName" == $schemeField){
				
				$needSkip = false;
				$input->readString($this->eBusinessCompanyName);
			...
			if ("payEnterpriseCode" == $schemeField){
				
				$needSkip = false;
				$input->readString($this->payEnterpriseCode);
			...
			if ("payEnterpriseName" == $schemeField){
				
				$needSkip = false;
				$input->readString($this->payEnterpriseName);
			...
			if ("salerCountry" == $schemeField){
				
				$needSkip = false;
				$input->readString($this->salerCountry);
			...
			if ("logisCompanyCode" == $schemeField){
				
				$needSkip = false;
				$input->readString($this->logisCompanyCode);
			...
			if ("logisCompanyName" == $schemeField){
				
				$needSkip = false;
				$input->readString($this->logisCompanyName);
	...
	public function write($output){
		...
		if($this->ebpCode !== null) {
			
			$xfer += $output->writeFieldBegin('ebpCode');
			$xfer += $output->writeString($this->ebpCode);
			
			$xfer += $output->writeFieldEnd();
		}
		
		
		if($this->ebpName !== null) {
			
			$xfer += $output->writeFieldBegin('ebpName');
			$xfer += $output->writeString($this->ebpName);
			
			$xfer += $output->writeFieldEnd();
		}
		
		
		if($this->ebcCode !== null) {
			
			$xfer += $output->writeFieldBegin('ebcCode');
			$xfer += $output->writeString($this->ebcCode);
			
			$xfer += $output->writeFieldEnd();
		}
		
		
		if($this->ebcName !== null) {
			
			$xfer += $output->writeFieldBegin('ebcName');
			$xfer += $output->writeString($this->ebcName);
		...
		if($this->currCode !== null) {
			...
			$xfer += $output->writeFieldBegin('currCode');
			$xfer += $output->writeString($this->currCode);
			
			$xfer += $output->writeFieldEnd();
		}
		
		
		if($this->eBusinessCompanyCode !== null) {
			
			$xfer += $output->writeFieldBegin('eBusinessCompanyCode');
			$xfer += $output->writeString($this->eBusinessCompanyCode);
			
			$xfer += $output->writeFieldEnd();
		}
		
		
		if($this->eBusinessCompanyName !== null) {
			
			$xfer += $output->writeFieldBegin('eBusinessCompanyName');
			$xfer += $output->writeString($this->eBusinessCompanyName);
			
			$xfer += $output->writeFieldEnd();
		}
		
		
		if($this->payEnterpriseCode !== null) {
			
			$xfer += $output->writeFieldBegin('payEnterpriseCode');
			$xfer += $output->writeString($this->payEnterpriseCode);
			
			$xfer += $output->writeFieldEnd();
		}
		
		
		if($this->payEnterpriseName !== null) {
			
			$xfer += $output->writeFieldBegin('payEnterpriseName');
			$xfer += $output->writeString($this->payEnterpriseName);
		...
		if($this->salerCountry !== null) {
			
			$xfer += $output->writeFieldBegin('salerCountry');
			$xfer += $output->writeString($this->salerCountry);
			
			$xfer += $output->writeFieldEnd();
		}
		
		
		if($this->logisCompanyCode !== null) {
			
			$xfer += $output->writeFieldBegin('logisCompanyCode');
			$xfer += $output->writeString($this->logisCompanyCode);
			
			$xfer += $output->writeFieldEnd();
		}
		
		
		if($this->logisCompanyName !== null) {
			
			$xfer += $output->writeFieldBegin('logisCompanyName');
			$xfer += $output->writeString($this->logisCompanyName);
