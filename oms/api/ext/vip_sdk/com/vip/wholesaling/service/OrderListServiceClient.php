...
class OrderListServiceClient{
	...
	public static function getService(){
		...
		if (! OrderListServiceClient::$isRegis){
			
			OrderListServiceClient::regis ();
			OrderListServiceClient::$isRegis = true;
		}
		
		
		$ctx = \Osp\Context\InvocationContextFactory::getInstance ();
		$ip = OrderListServiceClient::$DEFAULT_PROXY_IP;
		$port = OrderListServiceClient::$DEFAULT_PROXY_PORT;	
		try{
		...
		return new \com\vip\wholesaling\service\OrderListServiceHelper();
	}
