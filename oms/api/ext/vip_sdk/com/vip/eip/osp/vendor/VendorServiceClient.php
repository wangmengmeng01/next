...
class VendorServiceClient{
	...
	public static function getService(){
		...
		if (! VendorServiceClient::$isRegis){
			
			VendorServiceClient::regis ();
			VendorServiceClient::$isRegis = true;
		}
		
		
		$ctx = \Osp\Context\InvocationContextFactory::getInstance ();
		$ip = VendorServiceClient::$DEFAULT_PROXY_IP;
		$port = VendorServiceClient::$DEFAULT_PROXY_PORT;	
		try{
		...
		return new \com\vip\eip\osp\vendor\VendorServiceHelper();
	}
