...
class erpRequest
{
    ...
    public function makeSign()
    {
    	...
    	*/
    	...
    	qimen_service::$_data = str_replace('<?xml version="1.0" encoding="UTF-8"?>'.PHP_EOL, '<?xml version="1.0" encoding="UTF-8"?>', qimen_service::$_data);
    ...
    {   	
    	...
    	$rs = $this->utilObj->post_data1($apiUrl, qimen_service::$_data);
    ...
    public function get_dataBase_relation($type)
    {
        ...
        if ($type == 'DeliveryOrderConfirmInfo') {
			...
			$return_arr['qmWarehouseCode'] = 'qm_warehouse_code';
