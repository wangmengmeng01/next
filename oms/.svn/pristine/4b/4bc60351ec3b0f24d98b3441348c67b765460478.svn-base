...
class SearchOrderListByUserIdResp {
	...
	public function getName(){
		...
		return 'SearchOrderListByUserIdResp';
	}
			...
			if ("parentOrderList" == $schemeField){
				...
				while(true){
					...
					try{
						...
						$elem2 = new \com\vip\order\common\pojo\order\vo\ParentOrderInfoVO();
						$elem2->read($input);
						
						$this->parentOrderList[$_size2++] = $elem2;
					}
					catch(\Exception $e){
