...
class ImportDeliveryDetailRequest {
	...
	public function __construct($vals=null){
		...
		if (is_array($vals)){
			...
			if (isset($vals['deliveryDetails'])){
				
				$this->deliveryDetails = $vals['deliveryDetails'];
			}
	...
	public function getName(){
		...
		return 'ImportDeliveryDetailRequest';
	}
	...
	public function read($input){
		...
		while(true){
			...
			if ("deliveryDetails" == $schemeField){
				...
				while(true){
					...
					try{
						...
						$this->deliveryDetails[$_size0++] = $elem0;
					}
					catch(\Exception $e){
	...
	public function write($output){
		...
		if($this->deliveryDetails !== null) {
			...
			$xfer += $output->writeFieldBegin('deliveryDetails');
			
			if (!is_array($this->deliveryDetails)){
				
				throw new \Osp\Exception\OspException('Bad type in structure.', \Osp\Exception\OspException::INVALID_DATA);
			}
			
			$output->writeListBegin();
			foreach ($this->deliveryDetails as $iter0){
