...
<script type="text/javascript">
	...
	var batchViewUrl = '<?php echo Yii::app()->createUrl('outbound/deliveryDetailBatchRecord/index', array('id'=>'uid')); ?>';
	var excelExportFlag = <?php echo $excelExportFlag; ?>;
</script>
<div id="dg"></div>
<div id="remark_div"></div>
<script type="text/javascript" src="./static/js/moudles/outbound/delivery-deliveryRecordDetail.js"></script>