$(function() {
	$("#dg").datagrid({
		loadMsg : '正在加载中',
		title : '菜鸟电子面单接口日志',
		url : './index.php?r=interfaceLog/waybillLog/data',
		method : 'POST',
		rownumbers : true,
		...
		columns : [ [{
			...
			formatter : function(value, rowData, rowIndex) {
				var jsondata = {
					'taobao.wlb.waybill.i.seller.authorization' : '商家授权信息同步接口',
					'taobao.wlb.waybill.i.search' : '获取商家面单服务订购情况接口',
					'taobao.wlb.waybill.i.get' : '获取物流服务商电子面单号接口',
					'taobao.wlb.waybill.i.fullupdate' : '面单信息更新接口',
					'taobao.wlb.waybill.i.cancel' : '商家取消获取的电子面单号接口',
					'taobao.wlb.waybill.i.print' : '打印确认接口',
					'cainiao.waybill.ii.get' : '电子面单云打印接口',
					'cainiao.waybill.ii.cancel' : '商家取消获取的电子面单号接口',
					'cainiao.waybill.ii.search' : '查询面单服务订购及面单使用情况接口'
				};
