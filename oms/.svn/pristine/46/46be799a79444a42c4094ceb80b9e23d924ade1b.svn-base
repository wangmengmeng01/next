...
class HtCarrierSaleOrderResultModel {
	...
	public function getName(){
		...
		return 'HtCarrierSaleOrderResultModel';
	}
			...
			if ("saleOrderList" == $schemeField){
				...
				while(true){
					...
					try{
						...
						$elem0 = new \com\vip\haitao\orderservice\service\HtSaleOrderChbResultModel();
						$elem0->read($input);
						
						$this->saleOrderList[$_size0++] = $elem0;
					}
					catch(\Exception $e){
