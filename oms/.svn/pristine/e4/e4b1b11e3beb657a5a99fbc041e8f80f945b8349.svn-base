			...
			if ("scheduledSellingInfoList" == $schemeField){
				...
				while(true){
					...
					try{
						...
						$elem1 = new \com\vip\order\common\pojo\order\vo\ScheduledSellingInfoVO();
						$elem1->read($input);
						
						$this->scheduledSellingInfoList[$_size1++] = $elem1;
					}
					catch(\Exception $e){
