 ...
 */
class DeliveryDetailBatchRecord extends CActiveRecord
{
    ...
    {
        return '{{delivery_order_detail_batch_record}}';
    }
    ...
    public static function search($param)
    {
        ...
        $dataProvider = new CActiveDataProvider('DeliveryDetailBatchRecord', array(
            'sort' => array(
