<?php
/**
 * Notes:拼多多电子面单接口交互日志model
 * table: pdd_interface_log
 * Date: 2019/3/28
 * Time: 18:43
 */

class PddLog extends CActiveRecord
{
    ...
    public static function search()
    {
        ...
        $dataProvider = new CActiveDataProvider('PddLog',array(
            'sort'=>array(
