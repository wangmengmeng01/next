...
/**
 * 仓内加工单商品明细model
 * table: t_store_process_order_product_info
 */
class StoreProcessProductInfo extends CActiveRecord
{
    ...
    {
        return '{{store_process_order_product_info}}';
    }
    ...
    public static function search($param)
    {
        ...
        $dataProvider = new CActiveDataProvider('StoreProcessProductInfo', array(
            'sort' => array(
