...
<script type="text/javascript">
	...
	var deatilViewUrl = '<?php echo Yii::app()->createUrl('outbound/deliveryInvoiceDetail/index', array('id'=>'uid','name'=>'uname')); ?>';
	var excelExportFlag = <?php echo $excelExportFlag; ?>;
</script>
<div id="dg"></div>
<div id="remark_div"></div>
<script type="text/javascript" src="./static/js/moudles/outbound/delivery-deliveryOrderInvoice.js"></script>