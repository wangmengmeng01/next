...
<div class="ftitle">货主与商家关联信息维护界面</div>
<form id="form_relation"> 
<table>
    <tr style="display:none">
		<td>主键ID：</td>
		<td>
			<input type="text" name="Relation[relation_id]" id="relation_id" style="width:200px;" value="<?php echo $model['relation_id'] ?>" class='easyui-validatebox' maxLength="20"/>
		</td>
	</tr>
	<tr>
		<td>商家ID：</td>
