...
public class SysConfig<stat> {
    ...
    // 图片主机
    public static String uploadLocal = "/crmkh/files";
    ...
    public static String TYSQFLAG = "flase";
    ...
    public static String authId = "100000214";
    ...
    //手动干预异步导出死循环
    public static String exportExcelFlag = "false";
    ...
    //IE浏览器跳转到谷歌浏览器地址
    public static String IE_TO_CHROME_ADDRESS = "10.19.105.137/crmkh/login";
    //服务器地址(前面需要加http://)(https://devkyweixin.yundasys.com/)
    public static String FU_WU_IP = "http://10.19.105.137";
    
  //预警反馈数据--短信模板
    public static String WARNING_jizhun_ZB = "1000";//总部预警基准设置
    public static double WARNING_jizhun_ZB_double = Double.parseDouble(WARNING_jizhun_ZB);
    
    public static String WARNING_TEMPLATE_SZ = "重点注意：省总:%s,您好，%s日揽件量比上周日均揽件量下降超过百分之50（%s类以上的大客户），产生大客户预警的网点合计%s家（分别为%s），客户数量%s，请您重点关注上述网点大客户波动情况。大客户的开发与维护工作刻不容缓，感谢您的配合与支持！详情咨询市场营销中心 TEL：021-39296256；企业微信：李烁莹（市场营销中心）";
    
    public static String WARNING_TEMPLATE_WD = "重点关注：网点:%s，您好，%s日揽件量比上周日均揽件量下降超过百分之50（%s类以上的大客户），产生大客户预警的有%s个客户，具体详情登录内网—我的客户—新飞鸟系统—预警表查看或咨询市场营销中心TEL：021-39296256；企业微信：李烁莹（市场营销中心）";
    
    public static String WARNING_TEMPLATE_QZ = "重点注意：区总:%s，您好，%s日揽件量比上周日均揽件量下降超过百分之50（%s类以上的大客户），产生大客户预警的有%s个省份%s个网点%s客户，（分别为%s），请您重点关注上述省份网点大客户波动情况。大客户的开发与维护工作刻不容缓，感谢您的配合与支持！详情咨询市场营销中心 TEL：021-39296256；企业微信：李烁莹（市场营销中心）";
    
    public static String WARNING_TEMPLATE_ZB = "重点注意：总部:%s，您好，%s日揽件量比上周日均揽件量下降超过百分之50（%s票以上的客户），产生大客户预警的有%s个区%s个省%s个网点%s个客户，（分别为%s），请您重点关注上述省份网点大客户波动情况。大客户的开发与维护工作刻不容缓，感谢您的配合与支持！详情咨询市场营销中心 TEL：021-39296256；企业微信：李烁莹（市场营销中心）";
