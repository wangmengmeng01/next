...
public interface ReportTotaldataService {
	...
	List<ReportTotaldataDO> listNew(Bo_ReportTotaldata bo_ReportTotaldata,UserDO cipuser);
	
	int cityCount(Bo_ReportTotaldata bo_ReportTotaldata,UserDO cipuser);
	
	int branchCount(Bo_ReportTotaldata bo_ReportTotaldata,UserDO cipuser);
	
	int custCount(Bo_ReportTotaldata bo_ReportTotaldata,UserDO cipuser);
...
//    public List<CIPResource> getResources(CIPUser user, String resourceId);
	...
	List<Map<String, Object>> searchSellerPDD(
            HashMap<String, Object> cqkh_paramMap, String dsId);
