...
function exportExcel(action) {
	...
	var url = prefix + "/exportExcelCity"+"?start_date="+$('#start_date').val()+"&end_date="+$('#end_date').val()+"&qu_date="+$('#qu_date').val()
			+"&showType=city"+"&provinceId="+$('#provinceId').val()+"&cityId="+$('#cityId').val();
