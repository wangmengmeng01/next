...
function exportExcel(action) {
	...
	var url = prefix + "/exportExcel"+"?startDate="+$('#searchStartDate').val()+"&endDate="+$('#searchEndDate').val()+"&provinceId="+$('#searchProvinceId').val()
	  +"&cityId="+$('#searchCityId').val()+"&showType="+$('#searchShowType').val();
	  ...
	  xhr.onload = function () {
	    ...
	    if (this.status === 200) {
	      ...
	      reader.onload = function (e) {
	        ...
	        a.download = '预警表-公司表-'+nowTime+'.xlsx';
