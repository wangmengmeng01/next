...
public class NotCooperateCustomerDO implements Serializable {
	...
	private Integer id;
	//业务省
	@ExcelField(title = "省", order = 1)
	private String province;
	//业务省编码
	private String provinceId;
	//市
	@ExcelField(title = "市", order = 2)
	private String city;
	//一级网点编码
	...
	//省总拜访
	@ExcelField(title = "是否拜访", order = 6)
    private String provinceVisit;
	//省总拜访时间
	@ExcelField(title = "拜访时间", order = 7)
	private String provinceVisitTime;
	//联系人
	@ExcelField(title = "联系人", order = 8)
	private String contactName;
	//客户联系电话
	@ExcelField(title = "联系电话", order = 9)
	private String customerPhone;
	//产品类目
	@ExcelField(title = "产品类目", order = 10)
	private String productType;
	//日均单量
	@ExcelField(title = "日均单量", order = 11)
	private String dayAverageAmount;
	
	//产品均重
	@ExcelField(title = "产品均重", order = 12)
	private String productAverageHeavy;
	//是否泡货
	@ExcelField(title = "是否泡货", order = 13)
	private String soak;
	//上传人姓名及联系方式
	@ExcelField(title = "上传人姓名及联系方式", order = 14)
	private String uploadNamePhone;
	//客户所属平台
	@ExcelField(title = "客户所属平台", order = 15)
	private String customerPlatform;
	//合作同行及情况
	@ExcelField(title = "合作同行及情况", order = 16)
	private String cooperatePeerCase;
    //合作同行填写信息对象
    private List<CooperatePeerDO> listCooperatePeer;
	//客户发货地址
	@ExcelField(title = "客户发货地址", order = 17)
	private String customerDeliverAddress;
	//备注
	@ExcelField(title = "备注", order = 18)
	private String remark;
	//为合作原因
	@ExcelField(title = "未合作原因", order = 19)
	private String notCooperateCause;
	//客户意向
	@ExcelField(title = "客户意向", order = 20)
	private String customerIntention;
	//网点需求
	@ExcelField(title = "网点需求", order = 21)
	private String branchNeed;
	//上传日期
	@ExcelField(title = "上传时间", order = 22)
	private String time;
	//省公司网点反馈审核
	@ExcelField(title = "省公司网点反馈审核", order = 23)
	private String feedBackCheck;
	//省公司处理状态
	@ExcelField(title = "省公司处理状态", order = 24)
	private String state;
	//合作网点名称
	@ExcelField(title = "合作网点编码", order = 25)
	private String cooperateBranch;
	//绑定客户VIP账号
	@ExcelField(title = "绑定vip账号", order = 26)
	private String boundVipAccount;
	//省公司处理意见
	private String provinceDealOpinion;
	//省公司处理人
	@ExcelField(title = "省公司处理人", order = 27)
	private String provinceDealName;
	//省公司处理时间
	@ExcelField(title = "省公司处理时间", order = 28)
	private String provinceDealTime;
	//总部处理意见
	@ExcelField(title = "总部处理意见", order = 29)
	private String zongBuDealOpinion;
	//总部处理人
	@ExcelField(title = "总部处理人", order = 30)
	private String zongBuDealName;
	//总部处理时间
	@ExcelField(title = "总部处理时间", order = 31)
	...
	public String getProvinceVisitTime() {
		return provinceVisitTime;
	}
	public void setProvinceVisitTime(String provinceVisitTime) {
		this.provinceVisitTime = provinceVisitTime;
	}
