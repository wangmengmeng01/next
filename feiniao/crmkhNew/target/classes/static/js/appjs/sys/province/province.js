var prefix = "/crmkh/system/province";
$(function() {
	load();
			...
			.bootstrapTable(
					{
						...
						url : prefix +"/maintainProvincelist", // 服务器数据的加载地址
					//	showRefresh : true,
					//	showToggle : true,
					//	showColumns : true,
						iconSize : 'outline',
						...
						columns : [
								{
									...
									formatter : function(value, row, index) {
										var e = '<a class="btn btn-primary btn-sm '+s_editMaintainProvince_h+'" href="#" mce_href="#" title="编辑" onclick="editCity(\''
												+ row.provinceid
...
/*function edit(id) {
	if(s_editMaintainProvince_h=='hidden'){
		return;
	};
	...
	layer.open({
		...
		shadeClose : false, // 点击遮罩关闭层
		area : [ '800px', '520px' ],
		content : prefix + '/getMaintainProvince/' + id // iframe的url
	});
}*/
