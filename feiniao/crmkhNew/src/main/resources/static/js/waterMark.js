function watermark(settings) {
    ...
    //获取页面最大长度
    var page_height = Math.max(document.body.scrollHeight,$(".bootstrap-table").offsetHeight);
...
window.onresize = function () {
 watermark({ watermark_txt: user,watermark_width:50 }) 
};
*/
