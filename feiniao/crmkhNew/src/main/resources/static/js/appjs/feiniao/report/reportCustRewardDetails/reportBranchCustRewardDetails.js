...
*/	var gs = $('#searchGs').val();
	  ...
	  var url = prefix +"/exportBranchCustRewardDetailsExcel"+"?startDate="+$('#searchStartDate').val()+"&endDate="+$('#searchEndDate').val()
	  ...
	  xhr.onload = function () {
	    ...
	    if (this.status === 200) {
	      ...
	      reader.onload = function (e) {
	        ...
	        a.download = '客户奖励明细表(网点)-'+nowTime+'.xlsx';
