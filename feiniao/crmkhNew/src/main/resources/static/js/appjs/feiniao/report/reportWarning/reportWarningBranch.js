var prefix = "/crmkh/report/reportWarning";
$(function() {
	load();
	...
	$('#exampleTable')
			.bootstrapTable(
					...
					//	showColumns : true,
						...
						// 返回false将会终止请求
						columns : [ 
						   	{field : 'bigarea', title :  '大区', align : 'center', width : 100},
						   	{field : 'provinceName', title :  '省', align : 'center', width : 100},
						   	{field : 'cityName', title :  '市', align : 'center', width : 100},
						   	{field : 'yjmc', title :  '所属网点', align : 'center', width : 100},
						   	{field : 'branchName', title :  '上级公司', align : 'center', width : 100},
						   	{field : 'customerId', title :  '客户编码', align : 'center', width : 100},
						   	...
						   	{field : 'mobile', title :  '客户电话', align : 'center', width : 100},
						   	{field : 'gsaddr', title :  '客户公司地址', align : 'center', width : 100},
						   	{field : 'showCustomerSourceType', title :  '客户来源', align : 'center', width : 100},
						   	
						   	{field : 'lastOrderSum', title :  '揽件量', align : 'center', width : 100},
						   	{field : 'lastOrderAvg', title :  '日均量', align : 'center', width : 100},
						   	{field : 'orderAvg', title :  '上周日均量', align : 'center', width : 100},
						   	{field : 'monthRatio', title :  '周环比', align : 'center', width : 100},
						   	{field : 'showPriceLevel', title :  '客户类型', align : 'center', width : 100 },
...
function exportExcel(action) {
	...
	$('#exportExcelbtn').attr("readonly","readonly");//将input元素设置为readonly
	  ...
	  var url = prefix + "/exportBranchExcel"+"?startDate="+$('#searchStartDate').val()+"&endDate="+$('#searchEndDate').val()+"&provinceId="+$('#searchProvinceId').val()+"&cityId="+$('#searchCityId').val()
		+"&priceLevel="+$('#searchpriceLevel').val()+"&branchCode="+$('#searchBranchCode').val()+"&showType="+$('#searchShowType').val();
