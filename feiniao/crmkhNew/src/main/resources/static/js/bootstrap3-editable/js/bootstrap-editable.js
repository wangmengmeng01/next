        ...
        **/        
        render: function() {
            ...
            **/            
            ...
            this.input.$tpl.blur(function(){
//        	 	this.input.autosubmit();
            	$(this).closest('form').submit();//点击框外进行提交
            });
            ...
            .then($.proxy(function () {
                ...
                /* $(document).bind("click",function(e){
                	var target = $(e.target);
                	if(target.closest("a").length == 0){//点击id为sibader之外的地方触发
                		this.input.autosubmit();
                	}
                });*/
            	...
            	/*this.$form.on('click',':not(div.editable-input)',function(){
                ...
                if(this.input.error) {
                    ...
                    var pattern = />([^<]+)</;
                    var value = pattern.test(value) ? value.match(pattern)[1] : value;
    ...
    **/
    ...
    $.fn.editable.defaults = {
        ...
        **Please note**, that delegated targets can't be initialized with `emptytext` and `autotext` options, 
        ...
        <div id="user">
          <!-- empty -->
          <a href="#" style='text-decoration:none;' data-name="username" data-type="text" class="editable-click editable-empty" data-value="" title="Username">Empty</a>
          <!-- non-empty -->
          <a href="#" style='text-decoration:none;' data-name="group" data-type="select" data-source="/groups" data-value="1" class="editable-click" title="Group">Operator</a>
        </div>     
       ...
       **/
       input2value: function() { 
    	  ...
    	  /* function toDecimal2(x) {
    		   var pattern1 = /^[\u4e00-\u9fa5]$/;//匹配汉字
    		   var pattern2 = /^[\d.]+$/;//匹配数字和小数点
    		   if(!x){
    			  return "0.00"; 
    		   }else{
    			   if(pattern2.test(x)){
           ...
           return toDecimal2(this.$input.val());*/
       }, 
...
(function ($) {
    ...
    $.extend(Date.prototype, {
        ...
        render: function () {
            ...
            //"clear" link
            if(this.options.clear) {
                this.$clear = $('<a href="#" style="text-decoration:none;"></a>').html(this.options.clear).click($.proxy(function(e){
                    e.preventDefault();
                    e.stopPropagation();
                    this.clear();
                }, this));
