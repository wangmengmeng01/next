...
public class GenUtils {
	...
	public static void generatorCode(Map<String, String> table, List<Map<String, String>> columns,
		...
		String pack = config.getString("package").substring(config.getString("package").indexOf(".") + 1);
		if(pack.indexOf(".")!=-1) {
		...
		String pathName = config.getString("package").substring(config.getString("package").lastIndexOf(".") + 1) ; 
		pathName = pathName.replace(".", File.separator);
		map.put("pathName", pathName);
		map.put("pagePathName", pack.replace(".", "/"));
...
//						config.getString("package").substring(config.getString("package").lastIndexOf(".") + 1))));
				...
				zip.putNextEntry(new ZipEntry(getFileName(template, tableDO.getClassname(), tableDO.getClassName(),pack)));
	...
	public static String getFileName(String template, String classname, String className, String packageName) {
		...
		if (StringUtils.isNotBlank(packageName)) {
			subPath += packageName.replace(".", File.separator) + File.separator;
			packagePath += subPath;
		}
		...
		if (template.contains("Mapper.xml.vm")) {
			return "main" + File.separator + "resources" + File.separator + "mybatis" + File.separator + subPath
					+ File.separator + className + "Mapper.xml";
		}

		if (template.contains("list.html.vm")) {
			return "main" + File.separator + "resources" + File.separator + "templates" + File.separator + subPath
		...
		if (template.contains("list.js.vm")) {
			return "main" + File.separator + "resources" + File.separator + "static" + File.separator + "js"
					+ File.separator + "appjs" + File.separator + subPath + File.separator + classname
