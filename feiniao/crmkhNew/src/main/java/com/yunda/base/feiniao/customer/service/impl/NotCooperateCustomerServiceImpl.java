...
public class NotCooperateCustomerServiceImpl implements NotCooperateCustomerService {
	...
	public String getSummary() {
		...
		//以达成客户合作量
		map.put("state","已达成合作");
		Map<String, Object> cooperationMap = notCooperateCustomerDao.queryByState(map);
		//未合作合作客户数量1
		map.put("state","未达成合作");
		Map<String, Object> notCooperationMap = notCooperateCustomerDao.queryByState(map);
		//拼接给前端的数据
	...
	//根据大区权限获取省名称
	@Override
	public List<String> getProvinceNameByBigareaNames(List<String> regionIdsQX) {
		return notCooperateCustomerDao.getProvinceNameByBigareaNames(regionIdsQX);
	}
	//根据省id获取省名称
	@Override
