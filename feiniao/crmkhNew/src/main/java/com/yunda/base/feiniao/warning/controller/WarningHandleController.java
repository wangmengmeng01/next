...
public class WarningHandleController extends BaseController{
	...
	String wdFeedback(@PathVariable("id") Long id,Model model){
	    ...
	    String dqday = sdf.format(warningHandle.getWarnDate());
	    java.util.Date date;
		try {
        ...
        String startDatenum = sdf.format(cal.getTime());  
        if(StringUtils.isNotEmpty(warningHandle.getCustomerId()) && StringUtils.isNotEmpty(warningHandle.getCustomerSourceType())){
        	Map<String, Object> map = new HashMap<String, Object>();
			map.put("customerId", warningHandle.getCustomerId());
			map.put("warnDate", startDatenum);
			map.put("customerSourceType", warningHandle.getCustomerSourceType());
			WarningHandleDO warningHandle2 = warningHandleService.getWDFeedback(map);
			if(null !=warningHandle2){
				warningHandle.setBarnchDealUser(warningHandle2.getBarnchDealUser());
				warningHandle.setBranchCategory(warningHandle2.getBranchCategory());
				warningHandle.setBranchAveWeight(warningHandle2.getBranchAveWeight());
				warningHandle.setBranchDealType(warningHandle2.getBranchDealType());
				warningHandle.setBranchDealDesc(warningHandle2.getBranchDealDesc());
			}
	...
	String szFeedback(@PathVariable("id") Long id,Model model){
        ...
        if(StringUtils.isNotEmpty(warningHandle.getCustomerId()) && StringUtils.isNotEmpty(warningHandle.getCustomerSourceType())){
			...
			WarningHandleDO warningHandle2 = warningHandleService.getWDFeedback(map);
			if(null !=warningHandle2){
				warningHandle.setProvinceDealDesc(warningHandle2.getProvinceDealDesc());
