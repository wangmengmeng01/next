...
public class ExportWarningHandleDO implements Serializable {
	...
	public String getBranchAveWeight() {
		return branchAveWeight;
	}
	public void setBranchAveWeight(String branchAveWeight) {
		this.branchAveWeight = branchAveWeight;
	}
