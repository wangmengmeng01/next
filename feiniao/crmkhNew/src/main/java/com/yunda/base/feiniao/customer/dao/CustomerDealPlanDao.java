...
public interface CustomerDealPlanDao {
	...
	int countDataByProvinceName(CustomerDealPlanBO customerDealPlanBO);

	int countAllProvinceHuiZongData(CustomerDealPlanBO customerDealPlanBO);

	int countProvinceHuiZongDataByProvinceIds(CustomerDealPlanBO customerDealPlanBO);

	int countMcHuiZongDataByMcCode(CustomerDealPlanBO customerDealPlanBO);
}
